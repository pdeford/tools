...
def main(x, y, plot_type='scatter', plot_height=20, sharesize=False, line=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-r', '--line', action='store_true',
        help='Print correlation and equation of the least-squares line of best fit.')
    ...
    main(x, y, plot_height=args.height, plot_type=args.type, sharesize=args.xy_lim, line=args.line)